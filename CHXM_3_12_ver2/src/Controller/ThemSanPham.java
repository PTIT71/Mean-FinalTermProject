				 ...
				 if (!ServletFileUpload.isMultipartContent(request)) {
			        ...
			        try {
			            ...
			            if (formItems != null && formItems.size() > 0) {
			                ...
			                SanPham sanPham = new SanPham(tenxe, giaThanh, maLoai, maKT, hinhAnh);
			       ...
			       // getServletContext().getRequestDispatcher("/uploadshow.jsp").forward(request, response);
