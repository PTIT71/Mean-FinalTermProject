 ...
 -->      <!--//Shoping cart-->
   ...
   <body style="background: hsl(217, 12%, 84%)">   
	...
	<div class="col-lg-8 col-md-8">
		<form action="DatLaiMKAdminServlet?tenAD=${tenAD }" method="Post">
		
		  <div class="container">
		    <label for="uname"><b>Tên đăng nhập</b></label>
                <input type="text" value='${tenAD}' placeholder="Nhập tên đăng nhập" name="tenDangNhap" id="inputTenDN">
                <small id="validate-TenDN" class="text-danger"></small><br>
             <label for=""><b>Mật khẩu mới</b></label>
                <input type="password" placeholder="Nhập mật khẩu mới" name="matKhauMoi" id="inputMK">
		  ...
		  <div class="container" style="background-color:#f1f1f1">
		     ...
		     <a href="TrangChuAdmin.jsp"><button type="button"
