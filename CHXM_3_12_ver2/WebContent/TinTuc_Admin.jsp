			...
			<section class="content">
                ...
                <div class="col-sm-10">
                    <div class="box">
						...
						<h3>Bảng danh sách tin</h3>
						<a href="ThemTinTuc.jsp"> <button type="button">Thêm</button></a>
					</div>
                        <div class="box-body"  style="height:400px; overflow:scroll">
                            <table class="table table-hover table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td><c:out value="${tt.maTin}" /></td>
                                        <td><c:out value="${tt.tua}" /></td>
                                        <td><c:out value="${tt.noiDung}" /></td>
                                        <td><c:out value="${tt.hinhAnh}" /></td>
                                        <td><span> <a href="TinTuc/ShowFormSua?maTin=<c:out value='${tt.maTin}' />">
											...
											<td>
												<div>
													...
													<div > <!-- data-toggle="modal" data-target="#myModal" -->
														<a href="TinTuc/Xoa?maTin=<c:out value='${tt.maTin}' />">
														<button type="button" class="btn btn-info">
