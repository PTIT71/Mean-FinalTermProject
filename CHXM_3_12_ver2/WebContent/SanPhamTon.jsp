    ...
    data: [{        
        ...
        dataPoints: [      
            ...
            for (SanPham item : list) {
            	out.println(String.format("{ y:%d, label: \"%s\" },", item.getSoLuongTon(), item.getTenSP()));
            }
     		%>
        ]
    }]
                            ...
                            <div class="box-body">
                                ...
                                <table class="table table-bordered table-hover" id="myTable">
                                    ...
                                    <c:forEach items="${list }" var="sp">
                                        <tr>
                                            <td><c:out value="${sp.maSP }"></c:out></td>
                                            <td><c:out value="${sp.tenSP }"></c:out></td>
                                            <td><c:out value="${sp.soLuongTon }"></c:out></td>
                                        </tr>
                           			</c:forEach>
