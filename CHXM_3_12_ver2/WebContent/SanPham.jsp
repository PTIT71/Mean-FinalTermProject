						...
						<div class="box">
							...
							<div class="box-body"  style="height:400px; overflow:scroll">
								<div class="row">
									...
									<div class="col-xs-2">
										<div class="btn-them">
											<a href="SanPham/LoadTenLoai_maTSKT">
								...
								<table class="table table-bordered table-hover" id="myTable">
                                    ...
                                    <tr>
                                        ...
                                        <td><c:out value="${sp.maLoai}" /></td>
                                        <td><c:out value="${sp.maTSKT}" /></td>
                                        <td><span> <a href="SanPham/ShowFormSua?maSP=<c:out value='${sp.maSP}' />">
											...
											<td>
												<div>
													...
													<div > <!-- data-toggle="modal" data-target="#myModal" -->
														<a href="SanPham/Xoa?maSP=<c:out value='${sp.maSP}' />">
														<button type="button" class="btn btn-info">
