				...
				<ol class="breadcrumb">
					<li><a href="TrangChuAdmin.jsp"><i
							class="fa fa-dashboard"></i>Trang chủ</a></li>
								...
								<br>
				<input type="text" value='${tenAD }' name="tenAD"> &nbsp; &nbsp;<a href="Admin/DangXuat?tenAD=${tenAD}"> <button type="button" class="cancelbtn">Đăng xuất</button></a>
				&nbsp; &nbsp; &nbsp; &nbsp;<a href="Admin_DoiMK.jsp"><button type="button" class="cancelbtn">Đổi mật khẩu</button></a>
			</section>
